...
public abstract class AbstractCachingViewResolver extends WebApplicationObjectSupport implements ViewResolver {
    ...
    protected View createView(String viewName, Locale locale) throws Exception {
        /**
         * 加载视图,多个实现
         * 1. {@link ResourceBundleViewResolver#loadView(java.lang.String, java.util.Locale)}
         * 2. {@link UrlBasedViewResolver#loadView(java.lang.String, java.util.Locale)}
         * 3. {@link XmlViewResolver#loadView(java.lang.String, java.util.Locale)}
         */
