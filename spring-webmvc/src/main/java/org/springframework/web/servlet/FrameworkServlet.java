    ...
    protected WebApplicationContext initWebApplicationContext() {
        ...
        if (!this.refreshEventReceived) {
            ...
            synchronized (this.onRefreshMonitor) {
                ...
                /**
                 * 1. {@link FrameworkServlet#onRefresh(org.springframework.context.ApplicationContext)}
                 * 2. {@link  DispatcherServlet#onRefresh(org.springframework.context.ApplicationContext)}
                 */
                onRefresh(wac);
            }
        }
