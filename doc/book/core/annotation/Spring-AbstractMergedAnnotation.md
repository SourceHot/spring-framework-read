# Spring AbstractMergedAnnotation
- 类全路径: `org.springframework.core.annotation.AbstractMergedAnnotation`

- `AbstractMergedAnnotation` 提供了两个抽象方法交给子类实现
    1. getAttributeValue
    2. createSynthesized
    
- 类图

    ![AbstractMergedAnnotation](./images/AbstractMergedAnnotation.png)



- 父接口: `MergedAnnotation`分析文章: [MergedAnnotation](./Spring-MergedAnnotation-未完成.md)

整个类就不具体展开分析了. 下面贴出代码各位有兴趣的可以进行阅读
