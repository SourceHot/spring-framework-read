...
```xml
    ...
    <bean name="appleBean" class="org.sourcehot.spring.bean.Apple">
...
```java
        ...
        <bean name="rcBean" class="org.sourcehot.spring.bean.Rc"/>
...
<beans xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <bean name="obj" class="org.sourcehot.spring.bean.JavaObjectTest">
        <constructor-arg>
    ...
    <bean name="obj2" class="org.sourcehot.spring.bean.JavaObjectTest">
        <constructor-arg>
            <map>
