...
/**
 * <p>
 * The default implementation of the {@link Conversation} and {@link MutableConversation} interface.
 * </p>
 * 
 * @author Micha Kiener
 * @since 3.1
...
public class ConversationImpl extends DestructionAwareAttributeMap implements MutableConversation {
    ...
    /**
     * The reference to the conversation manager this conversation was created with. The manager is used to end this
     * conversation.
     */
     ...
     * isolated state. This is set to <code>true</code>, if a new conversation with {@link JoinMode#ISOLATED} is
     * created.
     */
    ...
    /**
     * The join count which is increased on the joining method and decreased on the end method.
     */
    ...
    /**
     * Default constructor, setting the last access timestamp to the current system time in milliseconds.
     */
    ...
    /**
     * Considers the internal attribute map as well as the map from the parent, if this is a nested conversation and is
     * not isolated.
     * 
    ...
    /**
     * @see org.springframework.conversation.Conversation#setAttribute(java.lang.String, java.lang.Object)
     */
    @Override
    ...
    /**
     * Is just delegated to {@link ConversationManager#endConversation(Conversation, ConversationEndingType)} .
     * 
    ...
    /**
     * Is just delegated to {@link ConversationManager#finalEndConversation(Conversation, ConversationEndingType)} .
     * 
    ...
    /**
     * Just increases the join count of this conversation to mark it being joined which is taken into account while
     * ending it.
     * 
    ...
    /**
     * @see org.springframework.conversation.Conversation#getChildConversations() 
     */
    public List<? extends Conversation> getChildConversations() {
        if (children == null){
    ...
    /**
     * @see org.springframework.conversation.manager.MutableConversation#addChildConversation(MutableConversation, boolean)
     */
    public void addChildConversation(MutableConversation conversation, boolean isIsolated) {
        ...
        conversation.setParentConversation(this, isIsolated);
    ...
    /**
     * @see org.springframework.conversation.manager.MutableConversation#removeChildConversation(MutableConversation)
     */
    ...
    /**
     * If this is a nested conversation, this method removes it from its parent by setting the nested child conversation
     * to <code>null</code> on its parent.
     */
     ...
     * TODO: what about a tail, if the parent has more than one child conversation?
     */
    ...
    /**
     * @return <code>true</code>, if this conversation has been timed out according to the last access timestamp and the
    ...
    /**
     * @param manager the conversation manager which created this conversation object
     */
