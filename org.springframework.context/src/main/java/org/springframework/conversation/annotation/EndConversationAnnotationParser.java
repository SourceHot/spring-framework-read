 ...
 *
 * @author Agim Emruli
 * @see org.springframework.conversation.annotation.EndConversation
 */
public class EndConversationAnnotationParser implements ConversationAnnotationParser {
	...
	public ConversationAttribute parseConversationAnnotation(AnnotatedElement annotatedElement) {
		...
		if (endConversation != null) {
			return new DefaultConversationAttribute(endConversation.value());
		}
		return null;
	}
}